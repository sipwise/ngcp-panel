...
class_has 'api_description' => (
    ...
    isa => 'Str',
    default => 
        'Specifies certain properties (preferences) for a <a href="#subscriberprofiles">Subscriber Profile</a>. The full list of properties can be obtained via <a href="/api/profilepreferencedefs/">ProfilePreferenceDefs</a>.'
);
