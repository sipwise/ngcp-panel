...
has_block 'fields' => (
    tag => 'div',
    class => [qw/modal-body/],
    render_list => [qw/attribute fielddev_pref label max_occur description data_type enum enum_add/],
);
...
sub validate_attribute {
    ...
    if ( $c->model('DB')->resultset('voip_preferences')->search_rs(
        { attribute => NGCP::Panel::Utils::Preferences::dynamic_pref_attribute_to_db($field->value) })->first 
    ) {
