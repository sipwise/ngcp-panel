...
$d->wait_and_screenshot("ssht_billing_logout.png");
$d->get_ok("$uri/login");
...
$d->wait_and_screenshot("ssht_billing_logged_in.png");
...
$d->wait_and_screenshot("ssht_billing_main_page.png");
...
$d->move_to(element => $row);
$edit_link->click;
$d->wait_and_screenshot("ssht_billing_fees_main_page.png");
...
$d->wait_and_screenshot("ssht_billing_fees_create_modal_zone_created.png");
...
$d->wait_and_screenshot("ssht_billing_fees_before_delete.png");
...
$d->wait_and_screenshot("ssht_billing_deleted_billing_fee.png");
diag('skip was here');
...
$d->move_to(element => $row);
$d->wait_and_screenshot("ssht_billing_weekdays_want_wednesday.png");
...
$d->wait_and_screenshot("ssht_wed_mod_added.png");
$d->findclick_ok(xpath => '//div[contains(@class,"modal")]//i[@class="icon-trash"]/..');

diag('skip was here');
$d->wait_and_screenshot("ssht_wed_mod_removed.png");
