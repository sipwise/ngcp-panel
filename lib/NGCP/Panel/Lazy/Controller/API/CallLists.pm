package NGCP::Panel::Lazy::Controller::API::CallLists;
...
use parent qw/NGCP::Panel::Lazy::Controller NGCP::Panel::Role::API::CallLists/;
...
sub GET :Allow {
    ...
    my $schema = $c->model('DB');
    {
        ...
        push @links,
            ...
            NGCP::Panel::Utils::DataHalLink->new(relation => 'self', href => sprintf('/%s?page=%s&rows=%s&%s', $c->request->path, $page, $rows, $href_data));
