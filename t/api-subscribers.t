...
#TT#8680
{
    ...
    my($res,$content) = $test_machine->request_post(sub{$_[0]->{primary_number} = ["12123132"];});
    $test_machine->http_code_msg(422, "Pimary number should be a hash", $res, $content);
    #MT#22853
    my($res,$content) = $test_machine->request_post(sub{$_[0]->{alias_numbers} = ["49221222899813", "49221222899814", "49221222899814"];});
