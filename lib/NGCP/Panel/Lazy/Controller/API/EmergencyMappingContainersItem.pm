package NGCP::Panel::Lazy::Controller::API::EmergencyMappingContainersItem;
...
use parent qw/NGCP::Panel::Lazy::Controller NGCP::Panel::Role::API::EmergencyMappingContainers/;
