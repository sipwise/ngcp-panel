...
class_has 'api_description' => (
    ...
    isa => 'Str',
    default => 
        'Provides a read-only overview of available sound handles and their corresponding groups.',
);
...
with 'NGCP::Panel::Role::API::SoundHandles';

class_has('resource_name', is => 'ro', default => 'soundhandles');
class_has('dispatch_path', is => 'ro', default => '/api/soundhandles/');
class_has('relation', is => 'ro', default => 'http://purl.org/sipwise/ngcp-api/#rel-soundhandles');
