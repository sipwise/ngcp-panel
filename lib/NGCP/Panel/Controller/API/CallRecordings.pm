...
sub api_description {
    return 'Defines calls being recorded on the system. The recorded streams belonging to a recorded calls can be found in <a href="#callrecordingstreams">CallRecordingStreams</a>.';
};
