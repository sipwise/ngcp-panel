package NGCP::Panel::Role::API::SecretaryManager;
...
use JSON::Types;
use NGCP::Panel::Form::SecretaryManagerAPI;
use NGCP::Panel::Utils::Subscriber;
use NGCP::Panel::Utils::Preferences;
use Readonly;
use Data::Dumper;

Readonly my $dset_name => 'sm_autoset';

sub get_form {
    my ($self, $c) = @_;

    return NGCP::Panel::Form::SecretaryManagerAPI->new(ctx => $c);
}

sub hal_from_item {
    my ($self, $c, $item, $form) = @_;
    my $type = "secretarymanager";
