...
has_block 'fields' => (
    tag => 'div',
    class => [qw/modal-body/],
    render_list => [qw/match_type match_part match_name expression expression_negation value_type rule_id rwr_set rwr_set_id rwr_dp rwr_dp_id enabled values value_add/ ],
);
