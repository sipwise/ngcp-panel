package NGCP::Panel::Lazy::Controller::API::DomainsItem;
...
use parent qw/NGCP::Panel::Lazy::Controller NGCP::Panel::Role::API::Domains/;
...
sub auto :Private {
    ...
    $c->log->error("~~~~~~~~ domainsitem auto");

    $self->set_body($c);
    $self->log_request($c);
    $c->log->error("~~~~~~~~ domainsitem done");
    return 1;
}
