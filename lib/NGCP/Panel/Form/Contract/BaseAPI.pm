...
has_field 'profile_definition' => (
    type => 'Select',
    #required => 1,
    options => [ 
        { label => 'id', value => 'single: by \'billing_profile_id\' field' },
        { label => 'profiles', value => 'schedule: by \'billing_profiles\' field' },
        { label => 'package', value => 'package: by \'profile_package_id\' field' },
    ],
    element_attr => {
        rel => ['tooltip'],
