...
class_has('resource_name', is => 'ro', default => 'profilepreferencedefs');
class_has('dispatch_path', is => 'ro', default => '/api/profilepreferencedefs/');
class_has('relation', is => 'ro', default => 'http://purl.org/sipwise/ngcp-api/#rel-profilepreferencedefs');
