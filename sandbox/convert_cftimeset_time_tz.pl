...
#example: timeset id 1 (subscriber id 209, Europe/Bucharest) *before* transformation:
#2221,1,NULL,NULL,NULL,2-2,6-6,0-59
#2223,1,NULL,NULL,NULL,2-2,7-12,NULL
#2225,1,NULL,NULL,NULL,2-2,13-13,0-00
#2227,1,NULL,NULL,NULL,3-3,6-6,0-59
#2229,1,NULL,NULL,NULL,3-3,7-9,NULL
#2231,1,NULL,NULL,NULL,3-3,10-10,0-00
#2233,1,NULL,NULL,NULL,4-4,6-6,0-59
#2235,1,NULL,NULL,NULL,4-4,7-12,NULL
#2237,1,NULL,NULL,NULL,4-4,13-13,0-00
#2239,1,NULL,NULL,NULL,5-5,6-6,0-59
#2241,1,NULL,NULL,NULL,5-5,7-18,NULL
#2243,1,NULL,NULL,NULL,5-5,19-19,0-45
#2245,1,NULL,NULL,NULL,6-6,6-6,0-59
#2247,1,NULL,NULL,NULL,6-6,7-15,NULL
#2249,1,NULL,NULL,NULL,6-6,16-16,0-00
#*after* tranformation:
#(new),1,NULL,NULL,NULL,2-2,8-8,0-59
#(new),1,NULL,NULL,NULL,2-2,9-14,NULL
#(new),1,NULL,NULL,NULL,2-2,15-15,0-00
#(new),1,NULL,NULL,NULL,3-3,8-8,0-59
#(new),1,NULL,NULL,NULL,3-3,9-11,NULL
#(new),1,NULL,NULL,NULL,3-3,12-12,0-00
#(new),1,NULL,NULL,NULL,4-4,8-8,0-59
#(new),1,NULL,NULL,NULL,4-4,9-14,NULL
#(new),1,NULL,NULL,NULL,4-4,15-15,0-00
#(new),1,NULL,NULL,NULL,5-5,8-8,0-59
#(new),1,NULL,NULL,NULL,5-5,9-20,NULL
#(new),1,NULL,NULL,NULL,5-5,21-21,0-45
#(new),1,NULL,NULL,NULL,6-6,8-8,0-59
#(new),1,NULL,NULL,NULL,6-6,9-17,NULL
#(new),1,NULL,NULL,NULL,6-6,18-18,0-00
#note how the 15 periods before were merged to 14!

print process_file('/home/rkrenn/temp/cftimeset_tz/cftimesets.txt',sub { #'/home/rkrenn/temp/cftimeset_tz/cftimesets.txt'
    my $item = shift;
    my @times;
    ...
    if ($converted_times) {
        ...
        #foreach my $timeelem (@$converted_times) {
        #    print(($timeelem->{id} // '(new)') . ',');
        #    print $timeelem->{time_set_id} . ',';
        #    print(($timeelem->{year} // 'NULL') . ',');
        #    print(($timeelem->{month} // 'NULL') . ',');
        #    print(($timeelem->{mday} // 'NULL') . ',');
        #    print(($timeelem->{wday} // 'NULL') . ',');
        #    print(($timeelem->{hour} // 'NULL') . ',');
        #    print(($timeelem->{minute} // 'NULL')); # . ',');
        #    print "\n";
        #}
    #exit;
    } else {
...
#print process_rows('voip_cf_time_sets', sub {
#    my $item = shift;
#    my @times;
...
sub apply_owner_timezone {
    ...
    if($timezone) {
        if (DateTime::TimeZone->is_valid_name($timezone)) {
            ...
            die("timezone '$timezone' is not a valid time zone");
            return;
        }
    } elsif ($subscriber_id) {
    ...
    if ($tz_name
        ...
        if ($offset_hrs * 3600 != $offset) {
            die("only full hours supported for timezone offset ($tz_name: $offset seconds = $offset_hrs hours)");
            return;
        }
