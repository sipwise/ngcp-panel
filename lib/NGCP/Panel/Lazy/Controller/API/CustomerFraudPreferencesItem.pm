package NGCP::Panel::Lazy::Controller::API::CustomerFraudPreferencesItem;
...
use parent qw/NGCP::Panel::Lazy::Controller NGCP::Panel::Role::API::CustomerFraudPreferences/;
