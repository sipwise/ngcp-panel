package NGCP::Panel::Lazy::Controller::API::PbxDeviceModelImagesItem;
...
use parent qw/NGCP::Panel::Lazy::Controller NGCP::Panel::Role::API::PbxDeviceModelImages NGCP::Panel::Role::API::PbxDeviceModels/;
