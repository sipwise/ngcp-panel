...
sub get_form {
    ...
    if($c->user->roles eq "admin" || $c->user->roles eq "reseller") {
        return (NGCP::Panel::Form::get("NGCP::Panel::Form::Subscriber::SubscriberAPI", $c),[qw/domain_id customer_id/]);
    } elsif($c->user->roles eq "subscriberadmin" || $c->user->roles eq "subscriber") {
        return (NGCP::Panel::Form::get("NGCP::Panel::Form::Subscriber::SubscriberSubAdminAPI", $c),[qw/domain_id customer_id/]);
    }
}
