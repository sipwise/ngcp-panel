package NGCP::Panel::Role::API::HeaderRuleActions;
...
sub dispatch_path {
    return '/api/headerruleactions/';
}

sub relation {
    return 'http://purl.org/sipwise/ngcp-api/#rel-headerruleactions';
}
...
sub get_form {
    my ($self, $c) = @_;
    return ( NGCP::Panel::Form::get("NGCP::Panel::Form::Header::ActionAPI", $c) );
}
