...
has_field 'mode' => (
    ...
    element_attr => {
        rel => ['tooltip'],
        title => ['The bnumber set mode. A blacklist forwards everything except numbers in the list, a whitelist only forwards numbers in this list.']
    },
);
...
has_field 'bnumbers' => (
    ...
    element_attr => {
        ...
        title => ['An array of bnumbers, each containing the key "bnumber" ' .
                  ...
                  '"bnumber" is the calling party number in E164 format to match. ' .
