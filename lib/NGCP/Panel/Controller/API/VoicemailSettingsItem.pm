package NGCP::Panel::Controller::API::VoicemailSettingsItem;
...
use base qw/Catalyst::Controller::ActionRole NGCP::Panel::Role::API::VoicemailSettings/;

class_has('resource_name', is => 'ro', default => 'voicemailsettings');
...
sub GET :Allow {
    my ($self, $c, $id) = @_;
    {
        ...
        last unless $self->resource_exists($c, voicemailsetting => $item);
