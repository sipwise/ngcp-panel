...
sub get_form {
    ...
    return NGCP::Panel::Form::get("NGCP::Panel::Form::Subscriber::SpeedDialAPI", $c);
}
...
sub hal_from_item {
    ...
    my $hal = NGCP::Panel::Utils::DataHal->new(
        links => [
            ...
            NGCP::Panel::Utils::DataHalLink->new(relation => 'ngcp:speeddials', href => sprintf("/api/speeddials/%d", $item->id)),
