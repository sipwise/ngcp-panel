package NGCP::Panel::Lazy::Controller::API::SubscriberRegistrationsItem;
...
use parent qw/NGCP::Panel::Lazy::Controller NGCP::Panel::Role::API::SubscriberRegistrations/;
