package NGCP::Panel::Controller::API::DevicePreferenceDefs;
...
sub resource_name{
    return 'nnnnerencedefs';
}
sub dispatch_path{
    return '/api/devicepreferencedefs/';
}
sub relation{
    return 'http://purl.org/sipwise/ngcp-api/#rel-devicepreferencedefs';
}
