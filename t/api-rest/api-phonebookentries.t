...
{#TT#34021
    ...
    test_phonebook_collection($reseller_phonebookentries_created);
    ...
    test_phonebook_collection($admin_phonebookentries_created);
}
...
sub test_phonebook_collection{
    ...
    $req = $test_machine->get_request_post( $collection_uri );
    $req->header('Content-Type' => $content_type);
    ($res,$content) = $test_machine->request_post($csv_data, $collection_uri.'&purge_existing=true');#
