...
is($d->get_text('//*[@id="content"]//div[contains(@class, "alert")]'), "Subscriber profile successfully created",  "Correct Alert was shown");
...
diag('Search for Profile');
is($d->get_text('//*[@id="content"]//div[contains(@class, "alert")]'), "Subscriber profile successfully updated",  "Correct Alert was shown");
$d->fill_element('//*[@id="subscriber_profile_table_filter"]/label/input', 'xpath', 'thisshouldnotexist');
ok($d->find_element_by_css('#subscriber_profile_table tr > td.dataTables_empty'), 'Table is empty');
$d->fill_element('//*[@id="subscriber_profile_table_filter"]/label/input', 'xpath', $profilename);
...
is($d->get_text('//*[@id="content"]//div[contains(@class, "alert")]'), "Preference record_call successfully updated",  "Correct Alert was shown");
...
$d->scroll_to_element($d->find_element("Call Blockings", 'link_text'));
is($d->get_text('//*[@id="content"]//div[contains(@class, "alert")]'), "Preference block_in_mode successfully updated",  "Correct Alert was shown");
...
diag('Check if value was set');
is($d->get_text('//*[@id="content"]//div[contains(@class, "alert")]'), "Preference block_in_clir successfully updated",  "Correct Alert was shown");
