...
has_field 'bootstrap_method' => (
    ...
    wrapper_class => [qw/ngcp-type-basic ngcp-devicetype ngcp-devicetype-basic/],
    options => [
...
has_field 'bootstrap_uri' => (
    ...
    wrapper_class => [qw/ngcp-devicetype ngcp-devicetype-basic ngcp-bootstrap-config ngcp-bootstrap-config-http ngcp-bootstrap-config-redirect_panasonic ngcp-bootstrap-config-redirect_yealink/],
    element_attr => {
        rel => ['tooltip'],
...
has_field 'bootstrap_config_http_sync_uri' => (
    ...
    wrapper_class => [qw/ngcp-devicetype ngcp-devicetype-basic ngcp-bootstrap-config ngcp-bootstrap-config-http/],
    element_attr => {
        rel => ['tooltip'],
...
has_field 'bootstrap_config_redirect_panasonic_user' => (
    ...
    default => '',
    wrapper_class => [qw/ngcp-devicetype ngcp-devicetype-basic ngcp-bootstrap-config ngcp-bootstrap-config-redirect_panasonic/],
    element_attr => {
        rel => ['tooltip'],
...
has_field 'bootstrap_config_redirect_yealink_user' => (
    ...
    default => '',
    wrapper_class => [qw/ngcp-devicetype ngcp-devicetype-basic ngcp-bootstrap-config ngcp-bootstrap-config-redirect_yealink/],
    element_attr => {
        rel => ['tooltip'],
...
has_field 'bootstrap_config_redirect_polycom_user' => (
    ...
    default => '',
    wrapper_class => [qw/ngcp-devicetype ngcp-devicetype-basic ngcp-bootstrap-config ngcp-bootstrap-config-redirect_polycom/],
    element_attr => {
        rel => ['tooltip'],
