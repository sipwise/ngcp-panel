...
sub GET :Allow {
    ...
    my $guard = $c->model('DB')->txn_scope_guard;
    {
        ...
        delete $resource->{webpassword} if $resource->{webpassword}; # since it's encrypted, no point to return it
...
sub DELETE :Allow {
    ...
    my $guard = $c->model('DB')->txn_scope_guard;
    {
        ...
        last unless $self->add_delete_journal_item_hal($c,sub {
            ...
            delete $_resource->{webpassword} if $_resource->{webpassword}; # since it's encrypted, no point to return it
