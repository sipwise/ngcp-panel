...
# TODO - don't depend on 3rd party + support switching between different selenium versions
...
# TODO - take care via according (Build-|Test-)Depends instead
...
# ----------------------
# On host:
# % docker build --tag="ngcp-panel-jessie" .
# % docker run -p 5999 -i -t -v $(pwd):/code:rw ngcp-panel-jessie:latest bash
#
# Inside docker:
#   su - selenium
