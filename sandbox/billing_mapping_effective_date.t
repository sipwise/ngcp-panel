...
where
  tcbpn.contract_id = ?
#order by
#  tcbpns.effective_start_time asc, tcbpns.profile_network_id asc
EOS5
            );
...
join tmp_contracts_billing_profile_network cbpn on cbpns.profile_network_id = cbpn.id and cbpn.base = 1
join (select
