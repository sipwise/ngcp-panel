...
has_block 'fields' => (
    tag => 'div',
    class => [qw/modal-body/],
    render_list => [qw/header header_part expression expression_negation value_type rule_id value_group_id rwr_set rwr_set_id rwr_dp rwr_dp_id enabled values value_add/ ],
);
