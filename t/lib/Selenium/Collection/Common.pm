...
sub create_contact {
    my($self, $contactemail, $reseller) = @_;
    ...
    $self->driver->fill_element('//*[@id="email"]', 'xpath', $contactemail);
    $self->driver->fill_element('//*[@id="company"]', 'xpath', 'SIPWISE');
    $self->driver->find_element('//*[@id="save"]')->click();
}

sub delete_contact {
    my($self, $contactemail, $cancel) = @_;
    ...
    $self->driver->fill_element('//*[@id="contact_table_filter"]/label/input', 'xpath', $contactemail);
    ok($self->driver->wait_for_text('//*[@id="contact_table"]/tbody/tr[1]/td[6]', $contactemail), 'Found contact');
