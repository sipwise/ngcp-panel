...
<create-subscriber account-id='".uri_escape($self->params->{redirect_params}->{profile})."' isp-name='".uri_escape($self->params->{redirect_params}->{profile})."'>
...
#    $self->redirect_server_call('register_model');
