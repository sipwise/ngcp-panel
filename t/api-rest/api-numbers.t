...

{
    ...
    $test_machine->request_put({subscriber_id => $subscriber1->{content}->{id}}, $alias2->{location});
    $test_machine->request_put({subscriber_id => $subscriber2->{content}->{id}}, $alias2->{location});
