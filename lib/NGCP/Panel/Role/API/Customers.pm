...
sub hal_from_customer {
    ...
    my $billing_profiles = NGCP::Panel::Utils::Contract::resource_from_mappings($customer,1);
    my $future_billing_profiles = NGCP::Panel::Utils::Contract::resource_from_mappings($customer);
