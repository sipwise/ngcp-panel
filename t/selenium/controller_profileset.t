...
diag("Try to create a empty Subscriber Profile");
...
diag("Check if cloned Profile Set has been deleted");
...
$d->fill_element('//*[@id="subscriber_profile_sets_table_filter"]/label/input', 'xpath', $clonedsetname);
ok($d->find_element_by_css('#subscriber_profile_sets_table tr > td.dataTables_empty'), 'Cloned Profile Set has been deleted');
