...
class_has('resource_name', is => 'ro', default => 'metaconfigdefs');
class_has('dispatch_path', is => 'ro', default => '/api/metaconfigdefs/');
class_has('relation', is => 'ro', default => 'http://purl.org/sipwise/ngcp-api/#rel-metaconfigdefs');
