package NGCP::Panel::Controller::API::SubscriberLocationMappingsItem;
...
use parent qw/NGCP::Panel::Role::EntitiesItem NGCP::Panel::Role::API::SubscriberLocationMappings/;
...
sub GET :Allow {
    my ($self, $c, $id) = @_;
    {
        ...
        last unless $self->resource_exists($c, subscriberlocationmapping => $item);
