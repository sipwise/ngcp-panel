...
if($remote_config->{config}->{features}->{cloudpbx}){
    ...
    {#TT#43350
        ...
        my($subscriber_other_reseller, $subscriberadmin_other_reseller) 
            = create_sub_and_subadmin($fake_data_other_reseller, $test_machine_other_reseller);
        ...
        my($subscriber_other_customer, $subscriberadmin_other_customer) 
            = create_sub_and_subadmin($fake_data_other_customer, $test_machine_other_customer);
        ...
        my($subscriber, $subscriberadmin) 
            = create_sub_and_subadmin($fake_data, $test_machine);
...
sub create_sub_and_subadmin {
    ...
    my $subscriber = $test_machine_l->check_create_correct(1, sub {
        my $num = $_[1]->{i};
        my $uniq = Test::FakeData::seq;
    ...
    my $subscriberadmin = $test_machine_l->check_create_correct(1, sub {
        ...
        diag("#------------------------ /create subscriberadmin\n");
    return $subscriber, $subscriberadmin;
}
