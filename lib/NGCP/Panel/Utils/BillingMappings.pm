...
join billing.contracts_billing_profile_network actual_billing_mapping on cbpns.profile_network_id = actual_billing_mapping.id and actual_billing_mapping.base = 1
join (select
  contract_id,
  ...
  and base = 1) as esd on actual_billing_mapping.contract_id = esd.contract_id and cbpns.effective_start_time = esd.effective_start_date
