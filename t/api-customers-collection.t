...
SKIP:{
    ...
    if(!$invoicetemplate->{total_count} ){
        skip("Testing requires at least one present invoice template. No creation is available.",1);
    }
    ...
    $test_machine->check_get2put(undef,undef,{ignore_fields => [qw/modify_timestamp create_timestamp/]});
