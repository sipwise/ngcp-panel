...
sub hal_from_contract {
    ...
    my $future_billing_profiles = NGCP::Panel::Utils::Contract::resource_from_mappings($contract);
    my $billing_profiles = NGCP::Panel::Utils::Contract::resource_from_mappings($contract,1);
...
sub update_contract {
    ...
    try {
        ...
        NGCP::Panel::Utils::Contract::remove_future_billing_mappings($contract) if $delete_mappings;
